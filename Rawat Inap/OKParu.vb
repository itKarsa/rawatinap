...
Public Class OKParu
    ...
    Sub autoNoRegOP()
        ...
        Try
            ...
            query = "SELECT SUBSTR(noRegistrasiOP,17,4) FROM t_registrasiokparu WHERE DATE(tglRegistrasiOP) = DATE(NOW()) ORDER BY CAST(SUBSTR(noRegistrasiOP,17,4) AS UNSIGNED) DESC LIMIT 1"
            cmdNoReg = New MySqlCommand(query, conn)
            drNoReg = cmdNoReg.ExecuteReader
            drNoReg.Read()
            If drNoReg.HasRows Then
                drNoReg.Read()
                noPermintaanOP = "OKP" + Format(Now, "yyMMddHHmmss") + "-" + (Val(Trim(drNoReg.Item(0).ToString)) + 1).ToString
                txtNoRegOp.Text = noPermintaanOP
            Else
                noPermintaanOP = "OKP" + Format(Now, "yyMMddHHmmss") + "-1"
                txtNoRegOp.Text = noPermintaanOP
            End If
            conn.Close()
    ...
    Sub autoNoTindakanOP()
        ...
        Try
            ...
            query = "SELECT SUBSTR(noTindakanOP,18,4) FROM t_tindakanokparu WHERE DATE(SUBSTR(tglUser,2,10)) = DATE(NOW()) ORDER BY CAST(SUBSTR(noTindakanOP,18,4) AS UNSIGNED) DESC LIMIT 1"
            cmdNoTin = New MySqlCommand(query, conn)
            drNoTin = cmdNoTin.ExecuteReader
            drNoTin.Read()
            If drNoTin.HasRows Then
                drNoTin.Read()
                noTindakanOP = "TOKP" + Format(Now, "yyMMddHHmmss") + "-" + (Val(Trim(drNoTin.Item(0).ToString)) + 1).ToString
                txtNoTindakan.Text = noTindakanOP
            Else
                noTindakanOP = "TOKP" + Format(Now, "yyMMddHHmmss") + "-1"
                txtNoTindakan.Text = noTindakanOP
            End If
            conn.Close()
        Catch ex As Exception
    ...
    Sub addRegistrasiOK()
        ...
        Try
            ...
            str = "INSERT INTO t_registrasiokparu(noRegistrasiOP,tglRegistrasiOP,noRM,
            ...
            MsgBox("Permintaan OK Paru berhasil dilakukan", MsgBoxStyle.Information, "Information")
        Catch ex As Exception
    ...
    Sub addTindakan()
        ...
        Try
            ...
            str = "INSERT INTO t_tindakanokparu(noTindakanOP,noRegistrasiOP,totalTarifTindakan,statusPembayaran,
            ...
            'MsgBox("Insert Tindakan berhasil dilakukan", MsgBoxStyle.Information, "Information")
        Catch ex As Exception
    ...
    Sub addDiagnosPra()
        ...
        Try
            Dim str As String
            Dim cmdTindak As MySqlCommand
            str = "INSERT INTO t_diagnosapasienokparu (noRegistrasiOP,diagnosaPra,tglDiagniosaPra,
    ...
    Sub updateBatal()
        ...
        Try
            Dim str As String
            Dim cmd As MySqlCommand
            str = "UPDATE t_registrasiokparu SET statusOP = '6', 
    ...
    Sub updateBatalDetail()
        ...
        Try
            Dim str As String
            Dim cmd As MySqlCommand
            str = "UPDATE t_detailtindakanokparu SET statusHapus = '1', 
                                                     idUser = CONCAT(idUser,';" & LoginForm.txtUsername.Text.ToUpper & "'),
                                                     tglUser = CONCAT(tglUser,';" & DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") & "') 
    ...
    Function tampilProses(noReg As String) As (noRegBf As String, stats As String, noTind As String)
        ...
        query = "SELECT reg.noRegistrasiOP,reg.tglRegistrasiOP,
                   ...
                   FROM t_registrasiokparu AS reg
             INNER JOIN t_tindakanokparu AS tnd ON reg.noRegistrasiOP = tnd.noRegistrasiOP
    ...
    Private Sub OKParu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf tmline = 0 Then
            ...
            PictureBox1.Image = My.Resources.okOrder
        ...
        ElseIf tmline = 1 Then
            ...
            PictureBox1.Image = My.Resources.okRegister
            btnBatal.Enabled = False
        ElseIf tmline = 2 Then
            ...
            PictureBox1.Image = My.Resources.okAnestesi
            btnBatal.Enabled = False
        ElseIf tmline = 3 Then
            ...
            PictureBox1.Image = My.Resources.okOperasi
            btnBatal.Enabled = False
        ElseIf tmline = 4 Then
            ...
            PictureBox1.Image = My.Resources.okRecovery
            btnBatal.Enabled = False
        ElseIf tmline = 5 Then
            ...
            PictureBox1.Image = My.Resources.okSelesai
            btnBatal.Enabled = False
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        If txtJenisOP.Text = "" Then
            Me.ErrorJenis.SetError(Me.txtJenisOP, "Tolong dipilih terlebih dahulu")
            MsgBox("Pilih Jenis Operasi terlebih dahulu", MsgBoxStyle.Exclamation, "Warning")
        ElseIf txtIcdPrimer.Text = "" Then
            Me.ErDiag.SetError(Me.txtIcdPrimer, "Tolong dipilih terlebih dahulu")
            MsgBox("Pilih Dokter terlebih dahulu", MsgBoxStyle.Exclamation, "Warning")
        ElseIf txtDokter.Text = "" Then
            Me.ErrorDokter.SetError(Me.txtDokter, "Tolong dipilih terlebih dahulu")
            MsgBox("Pilih Dokter terlebih dahulu", MsgBoxStyle.Exclamation, "Warning")
        ElseIf txtDokterPra.Text = "" Then
            Me.ErDokPra.SetError(Me.txtDokterPra, "Tolong dipilih terlebih dahulu")
            MsgBox("Pilih Dokter terlebih dahulu", MsgBoxStyle.Exclamation, "Warning")
        ElseIf txtKet.Text = "" Then
            Me.ErrorKet.SetError(Me.txtKet, "Tolong dituliskan terlebih dahulu")
